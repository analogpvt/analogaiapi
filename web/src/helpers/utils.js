  ...
  if (error.message) {
    if (error.name === 'AxiosError') {
      switch (error.response.status) {
        case 401:
          // toast.error('Error: Not logged in or has expired, please log in again！', showErrorOptions);
        ...
        case 429:
          ...
          break;
        case 500:
          toast.error('Error: internal server error, please contact administrator！', showErrorOptions);
          break;
        case 405:
